    ...
    return (
        <div className="relative px-4 sm:px-6 lg:px-8 font-worksans-light">
            <div className="mt-6 prose prose-blue prose-lg text-gray-500 mx-auto">
                ...
                Usted se compromete a indemnizar y eximir de responsabilidad a Teos Labs (y a sus directivos, empleados y agentes), incluidos los costes y los honorarios de los abogados, por cualquier reclamación o demanda presentada por un tercero debido a, o derivada de 
                <ul>
